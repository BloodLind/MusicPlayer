...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "MusicPlayer.Xamarin.Android.dll" comes first in this list. */
		"MusicPlayer.Xamarin.Android.dll",
		"FormsViewGroup.dll",
		"MusicPlayer.Core.dll",
		"MusicPlayer.Xamarin.dll",
		"MvvmCross.dll",
		"MvvmCross.Forms.dll",
